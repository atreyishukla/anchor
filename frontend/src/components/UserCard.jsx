...
function UserCard({ user, isConnection }) {
	return (
		<div className='font-primary bg-accent rounded-lg shadow p-4 flex flex-col items-center transition-all hover:shadow-md'>
			...
			<p className='text-primary text-center'>{user.headline}</p>
