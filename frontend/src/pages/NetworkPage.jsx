		...
		<div className='grid grid-cols-1 lg:grid-cols-4 gap-6'>
			...
			<div className='col-span-1 lg:col-span-3'>
				<div className='bg-secondary rounded-lg shadow p-6 mb-6'>
					<h1 className='text-info text-2xl font-bold mb-6'>My SeaLink</h1>
					...
					{connectionRequests?.data?.length > 0 ? (
						...
						<div className='bg-accent rounded-lg shadow p-6 text-center mb-6'>
							...
							<p className='text-gray-600 mt-2'>
								Explore suggested links below to expand your network!
							</p>
						</div>
					)}
					{connections?.data?.length > 0 && (
						<div className='mb-8'>
							<h2 className='text-info text-xl font-semibold mb-4'>My Links</h2>
